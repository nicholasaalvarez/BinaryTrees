...
// Create BST Obj
cop3530::BSTRAND<int, char, compare_Kint, is_equals_Kint> bst;
...
TEST_CASE( "BST Look-Up/Contains Test" ) {
    ...
    REQUIRE( bst.balance()  < bst.height()    );
...
TEST_CASE( "BST Insertion Algorithm Test" ) {
    ...
    // Worst Case N-1
    // AVL Perfectly balanced tree log2N
    bst.clear();
    ...
    REQUIRE( bst.height()   <  250  );  // 179
    REQUIRE( bst.balance()  <  250  );  // 179
    std::cout<<"BSTRAND: Inserting Ascending Keys 0-1000 Balance= "<<bst.balance()<<" Height ="<<bst.height()<<std::endl;
    ...
    REQUIRE( bst.size()     <  1000  );
    REQUIRE( bst.height()   <  24    );  // 21
    REQUIRE( bst.balance()  <  10    );  // 3
    std::cout<<"BSTRAND: Inserting Random    Keys 0-1000 Balance= "<<bst.balance()<<" Height ="<<bst.height()<<std::endl;
...
TEST_CASE( "BST Copy Constructor/Assignment Test" ) {
    ...
    cop3530::BSTRAND<int, char, compare_Kint, is_equals_Kint> dst(bst);
    REQUIRE( dst.size()  == 12 );
