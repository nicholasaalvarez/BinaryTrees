...
// Create BST Obj
cop3530::BSTLEAF<int, char, compare_Kint, is_equals_Kint> bst;
...
TEST_CASE( "BST Insertion Algorithm Test" ) {
    ...
    std::cout<<"BSTLEAF: Inserting Ascending Keys 0-1000 Balance= "<<bst.balance()<<" Height ="<<bst.height()<<std::endl;
    ...
    std::cout<<"BSTLEAF: Inserting Random    Keys 0-1000 Balance=  "<<bst.balance()<<" Height ="<<bst.height()<<std::endl;
    std::cout<<"BSTLEAF: SIZE =  "<<bst.size()<<std::endl;
...
TEST_CASE( "BST Copy Constructor/Assignment Test" ) {
    ...
    cop3530::BSTLEAF<int, char, compare_Kint, is_equals_Kint> dst(bst);
    REQUIRE( dst.size()  == 12 );
